...
class CBAMBlock(nn.Module):
    def __init__(self, channel, kernel_size=49, reduction=16):
        super().__init__()
...
class DecoderTransformer(nn.Module):
    ...
    def forward(self, x_1, x_2):
        ...
        c1_1 = c1_1 + self.CBAM1(c1_1)
        c2_1 = c2_1 + self.CBAM2(c2_1)
        c3_1 = c3_1 + self.CBAM3(c3_1)
        c4_1 = c4_1 + self.CBAM4(c4_1)
        # print(c1_1.shape)
        # print(c2_1.shape)
        # print(c3_1.shape)
        # print(c4_1.shape)
        ...
        c1_2 = c1_2 + self.CBAM1(c1_2)
        c2_2 = c2_2 + self.CBAM2(c2_2)
        c3_2 = c3_2 + self.CBAM3(c3_2)
        c4_2 = c4_2 + self.CBAM4(c4_2)
